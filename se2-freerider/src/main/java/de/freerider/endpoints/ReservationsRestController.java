...
class ReservationsRestController implements ReservationsEP {
    ...
    @Override
    public Iterable<Reservation> findAllCustomers() {
    ...
    public Reservation findCustomerById(@PathVariable long id) {
        ...
        //
        Reservation found = dao.findCustomerById(id)
    ...
    @Override
    public ResponseEntity<Reservation> createCustomer(@RequestBody Map<String, Object> jsonData) {
        //
        logger.info(String.format("--- received POST (create): Customer JSON data:"));
        //
        try {
            //
            Reservation customer = dao.createCustomer(jsonData);
            //
